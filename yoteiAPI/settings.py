"""
Django settings for yoteiAPI project.
...
SECRET_KEY = 'django-insecure-t^(q9z7z!v=@_vuur0#g7#bpe3^7y^zt(34r$2a098k&kac!a4'
...
WSGI_APPLICATION = 'yoteiAPI.wsgi.application'
